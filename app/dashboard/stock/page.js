  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
        <div>
          <h1 style={{ color: theme.navy, margin: 0 }}>Inventory Management</h1>
          <p style={{ color: theme.gray, margin: "4px 0 0", maxWidth: 480 }}>
            Real-time tracking of Dental and El3awama stock across the clinic.
          </p>
        </div>
        ...
        {["dental", "el3awama"].map((c) => (
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: "none",
              background: category === c ? theme.navy : "#fff",
              color: category === c ? "#fff" : theme.navy,
              fontWeight: 700,
              cursor: "pointer",
              fontSize: 13,
      ...
      <div style={{ background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 20px rgba(39,33,77,0.06)" }}>
        ...
        {!loading && filtered.length === 0 && (
          <div style={{ padding: 24, textAlign: "center", color: theme.gray }}>No items yet in {category === "dental" ? "Dental" : "El3awama"} Stock.</div>
        )}
      </div>
      ...
      {showAddItem && <AddItemModal category={category} onClose={() => setShowAddItem(false)} onSaved={load} />}
...
function AddItemModal({ category, onClose, onSaved }) {
  ...
  return (
    <Modal title={`Add ${category === "dental" ? "Dental" : "El3awama"} Item`} onClose={onClose}>
